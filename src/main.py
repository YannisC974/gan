...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        # Validation
        val_loss_D, val_loss_G = validate(generator, discriminator, val_loader, criterion, device)

        # Log the results
        print(f'Epoch [{epoch+1}/{args.epochs}], '
              f'Train Loss D: {train_loss_D:.4f}, Train Loss G: {train_loss_G:.4f}, '
              f'Val Loss D: {val_loss_D:.4f}, Val Loss G: {val_loss_G:.4f}')
        ...
        early_stopping(val_loss_G, generator)
