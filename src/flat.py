...
def flatten_images(input_dir, output_dir):
    ...
    processed_files = set()  # Keep track of already used filenames

    for root, _, files in os.walk(input_dir):
        for filename in files:
            # Process image files with supported extensions
...
# Usage
input_directory = os.path.join(source_dir, 'NEH_UT_2021RetinalOCTDataset')
output_directory = os.path.join(source_dir, 'NEH_UT_2021RetinalOCTDataset_Flat')
